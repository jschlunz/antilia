 ...
 */
public class TableRadioChoice<T> extends AbstractSingleSelectChoice<T> implements IOnChangeListener
{
	 ...
	 */
	public TableRadioChoice(final String id)
	{
		super(id);
	}
	 ...
	 */
	public TableRadioChoice(final String id, final List<T> choices)
	{
		super(id, choices);
	}
	 ...
	 */
	public TableRadioChoice(final String id, final List<T> choices, final IChoiceRenderer<T> renderer)
	{
	 ...
	 */
	public TableRadioChoice(final String id, IModel<T> model, final List<T> choices)
	{
	 ...
	 * @see org.apache.wicket.markup.html.form.AbstractChoice#AbstractChoice(String, IModel)
	 */
	public TableRadioChoice(String id, IModel<List<? extends T>> choices)
	{
		super(id, choices);
	}
	 ...
	 * @see org.apache.wicket.Component#Component(String, IModel)
	 */
	public TableRadioChoice(String id, IModel<T> model, IModel<List<? extends T>> choices)
	{
		super(id, model, choices);
	}
	 ...
	 * @see org.apache.wicket.Component#Component(String)
	 */
	public TableRadioChoice(String id, IModel<List<? extends T>> choices, IChoiceRenderer<T> renderer)
	{
		super(id, choices, renderer);
	}
	 ...
	 * @return this
	 */
	public final TableRadioChoice<T> setPrefix(String prefix)
	{
	 ...
	 * @return this
	 */
	public final TableRadioChoice<T> setSuffix(String suffix)
	{
