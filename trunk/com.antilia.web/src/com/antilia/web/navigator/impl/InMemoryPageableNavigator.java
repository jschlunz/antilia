 ...
 */
public class InMemoryPageableNavigator<E extends Serializable> implements ILoadablePageableNavigator<E> {
	...
	public IPageableNavigator<E> duplicate() {
		...
		return new InMemoryPageableNavigator<E>(newColection, this.query.getEntityClass());
	}
}
