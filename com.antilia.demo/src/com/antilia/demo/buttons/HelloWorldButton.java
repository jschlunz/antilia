...
import com.antilia.demo.simple.hello.HelloPanel;

/**
 * 
 * @author Ernesto Reinaldo Barreiro (reiern70@gmail.com)
 */
public class HelloWorldButton extends AppNavigationButton {
	 ...
	 * @param page
	 */
	public HelloWorldButton(Index page) {
		super("helloworld",page);
	}
