...
public class User implements java.io.Serializable {
	...
	@Column(name = "parent", unique = false, nullable = true, length = 10)
	private User parent;
	...
	public boolean equals(Object obj) {
		if(obj instanceof User) {
			return 
			(name.toLowerCase().equals(((User)obj).getName()))& 
			(lastName.toLowerCase().equals(((User)obj).getLastName()))&
			(email.toLowerCase().equals(((User)obj).getEmail()));
		}
		return false;
	}
