 ...
 * Copyright 2006-2007.
 */
package com.antilia.web.navigator.impl;
 ...
 */
public class DataProviderPageableNavigator<E extends Serializable> implements ILoadablePageableNavigator<E> {
	 ...
	 * @param collection
	 */
	public DataProviderPageableNavigator(IDataProvider<E> dataProvider, IQuery<E> query) {
	...
	public IPageableNavigator<E> duplicate() {
		return new DataProviderPageableNavigator<E>(this.dataProvider, this.query, true);
	}
